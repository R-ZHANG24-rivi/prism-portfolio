  ...
  return (
    <section className="ending-page" id="ending" aria-labelledby="ending-title">
      ...
      <button className="ending-page__prism" type="button" onClick={() => onBackToTop?.('home')} aria-label="返回 PRISM 首页">
        <img src="/assets/portfolio/home/prism.png" alt="透明棱镜" />
      </button>
      ...
      <footer className="ending-page__footer">
        ...
        <a href="/#home" onClick={(event) => { if (onBackToTop) { event.preventDefault(); onBackToTop('home'); } }}>BACK TO TOP <span>↑</span></a>
      </footer>
    </section>
  );
}
...
export default function EndingPage() {
  return (
    <main>
      <PortfolioNav />
      <EndingSection onBackToTop={() => { window.location.href = '/#home'; }} />
    </main>
  );
}
